...
// A bit of an overkill for just two languages, but now ready for more!!
switch (process.env.CONVERSATION_LANG) {
  case 'en':
    process.env.WORKSPACE_ID = process.env.EN_WORKSPACE_ID
    break;
  case 'nl':
    process.env.WORKSPACE_ID = process.env.NL_WORKSPACE_ID
    break;
  default:
    process.env.WORKSPACE_ID = process.env.EN_WORKSPACE_ID
}
